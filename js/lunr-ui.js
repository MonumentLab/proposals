...
var result = '<div class="result"><a href="/monuments/' + item.pid + '"><img class="sq-thumb-sm" src="/assets/monuments/thumbs/' + item.image_file_name.toUpperCase() + '"/>&nbsp;&nbsp;&nbsp;<p><span class="title">' + title + '.</span><br>' + meta + '</p></a></div>';
results_div.append(result);
}
});
});